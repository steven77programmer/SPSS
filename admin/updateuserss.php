...
<div class="container" id="handcont">
    ...
    <button id="iconssph" class="data-open-modal3" style="margin-left:3%;" >
    <span class="material-symbols-outlined" id="iconsss">
person_add
</span></button>
</div>
<div class="container" id="admicont" >
    ...
    <div class="container-item " id='thh' >E-mail</div>
    <div class="container-item " id='thh' >Password</div>
    <button id="iconsspa" class="data-open-modal4" style="margin-left:3%;" >
    <span class="material-symbols-outlined" id="iconsss">
person_add
</span></button>
</div>
<div class="container" id="studcont2">
    <div class="container-item " id='ths' >Control-id</div>
    <div class="container-item " id='ths' >Roll no</div>
    <div class="container-item " id='ths' >E-mail</div>
    <div class="container-item " id='ths' >Registered no</div>
...
if(password.value.length!=0 && regexp.test(password.value))
{
     $.ajax({
                              ...
                              type: 'POST',
                              url: 'adad_change.php',
                              data: {use:user.innerText,pas:password.value,mai:mail.value},
                              success:function(data){
                              // console.log(data);
                               if(data=="P"){
