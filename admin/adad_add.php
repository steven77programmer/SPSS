...
if($count>0){
    ...
    $ress3=mysqli_query($con,"SELECT * FROM admin WHERE admin_email='$email'");
    $countt3=mysqli_num_rows($ress3);
   if($countt3>0){
    echo "MU";
  }
   else{
    mysqli_query($con,"INSERT INTO `admin`(`admin_username`, `admin_email`, `admin_password`) VALUES ('$use','$email','$encryption')");
