                ...
                <div class="container">
                        <div class="post" style="background: none;width:100%;">
                            ...
                            <div id="post-controlid"  class="post-con-itm">Control-Id
                                <p id="contentHoldercid" ></p> 
                            </div>
                            <div id="post-rollno"  class="post-con-itm">Roll-no
                                <p id="contentHolderrno" ></p> 
                            </div>
...
<div id="post-controlid"  class="post-con-itm">Control-Id
    <p id="mcontentHoldercid" ></p> 
</div>
<div id="post-rollno"  class="post-con-itm">Roll-no
    <p id="mcontentHolderrno" ></p> 
</div>
<div id="post-mail"  class="post-con-itm" >E-mail<br/>
    <p id="mcontentHoldermai"  placeholder=""></p>
</div>
...
let  mcontrolid = document.querySelector('#mcontentHoldercid');
mcontrolid.innerText = n[0];
let  mrno = document.querySelector('#mcontentHolderrno');
mrno.innerText = n[1];
