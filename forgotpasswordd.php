...
<head>
  <link id="style-toggle" rel="stylesheet" href="style.css">
    ...
    <title>Forgot Passowrd Page</title>   
</head>
<div class="prebg">
...
<p class="su-heading">Forgot Password:</p>
        ...
        <div style="margin-top:6%;">--or--</div>
         <div class="use-cont"><p class="su-sbheading" style="color:black;">Enter Email</p><input type="text" class="luse" name="lluse"  placeholder="email used in sign up" style="background:black;"/></div>
      ...
      <!--  <div class="pas-cont"><p class="su-sbheading" style="color:black;">Enter New Password</p><input type="text" class="lpas" name="llpas" style="background:black;"/></div>
        ...
        <div style="margin-top:6%;">--or--</div>
         <div class="use-cont"><p class="su-sbheading">Enter Email</p><input type="text" class="luse" name="lluse" id="llema" placeholder="Email used in sign up" required/></div>
...
Email.send({
    ...
    SecureToken : "34b9cc64-1e85-4c28-afa4-a40890992ade",
 //  Password : "D0A0BDCB1DDC540C51D21AA44308B112235C",
 // Password:"tzybjzgcalkfuvkv",
    //To : rto,
     To : "rujiihelpdesk@gmail.com",
    From : "healthcarepathlabs4051@gmail.com",
